...
TEST(esEncuestaValidaTEST, invalidaHogarSinIndividuos) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2},
                {22866, 2020,   3,  317157, 627217, 2,  42, 1,  1,  2,  2,  2},
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1,  2}};
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
...
TEST(esEncuestaValidaTEST, invalidaCantidadIncorrectaColumnasIndividuos) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2},
                {22866, 2020,   3,  317157, 627217, 2,  42, 1,  1,  2,  2,  2},
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1,  2}};
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000},
                {20957, 2020,   2,  1,  3,  2,  82, 0,  0,  25000},
                {22866, 2020,   1,  0,  3,  1,  31, 1,  3,  59000},
                {22866, 2020,   2,  1,  3,  2,  28, 1,  3,  0    },
                {22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000}};
...
TEST(esEncuestaValidaTEST, valoresDeHogarNoEnRango) {
    //                                                cantidad de dormitorios
    //                                        cantidad de habitaciones  |
    //                                                              |   |
    //                                                              v   v
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2},
                {22866, 2020,   3,  317157, 627217, 2,  42, 1,  1,  5,  0,  2},
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1,  2}};
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
                {20957, 2020,   2,  1,  3,  2,  82, 0,  0,  25000,  10},
                {22866, 2020,   1,  0,  3,  1,  31, 1,  3,  59000,  10},
